<?php
include ("../kelas/izin_ketidakhadiran.php");//menyertakan file izin_ketidakhadiran.php yang berada di folder ../kelas. 
//file berisi definisi kelas Izin dan berkoneksi dengan database.

$Izin = new Izin();//membuat objek baru dari kelas Izin. Constructor dari kelas Izin secara langsung dioperasikan,
// yang akan menginisialisasi koneksi ke database

$izinketidakhadiran = $Izin->tampilData();//memanggil metode tampilData() dari objek $Izin, yang berguna mengambil atau menampilkan data dari tabel terkait izin ketidakhadiran. 
...
<html lang="en">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Data Perizinan</a>
...
<div class="container">
    <div class="row">
        <center><h2>Data Izin Ketidakhadiran Pegawai</h2></center>
    <table class="table">
