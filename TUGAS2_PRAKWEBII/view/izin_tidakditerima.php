<?php
include ("../kelas/tidakditerima.php");//menyertakan file tidakditerima.php yang berada di folder ../kelas. 
//file berisi definisi kelas PutusantidakDiterima dan berkoneksi dengan database.

$putusan = new PutusanTidakDiterima();//membuat objek baru dari kelas PutusanTidakDiterima. Constructor dari kelas PutusanTidakDiterima secara langsung dioperasikan,
// yang akan menginisialisasi koneksi ke database

$izinketidakhadiran = $putusan->proses();//memanggil metode tampilData() dari objek $putusan, yang berguna mengambil atau menampilkan data dari tabel terkait putusan yang tidak diterima. 
...
<div class="container">
    <div class="row">
        <center><h2>Data Izin Ketidakhadiran Pegawai dengan Putusan Tidak Diterima</h2></center>
    <table class="table">
