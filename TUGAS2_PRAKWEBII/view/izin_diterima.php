<?php
include ("../kelas/diterima.php");//menyertakan file diterima.php yang berada di folder ../kelas. 
//file berisi definisi kelas PutusanDiterima dan berkoneksi dengan database.

$putusan = new PutusanDiterima();//membuat objek baru dari kelas PutusanDiterima. Constructor dari kelas PutusanDiterima secara langsung dioperasikan,
// yang akan menginisialisasi koneksi ke database

$izinketidakhadiran = $putusan->proses();//memanggil metode tampilData() dari objek $putusan, yang berguna mengambil atau menampilkan data dari tabel terkait putusan yang diterima . 
...
<div class="container">
    <div class="row">
        <center><h2>Data Izin Ketidakhadiran Pegawai dengan Putusan Diterima</h2></center>
    <table class="table">
